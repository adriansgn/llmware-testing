...
def setup_library(library_name):
    ...
    library.add_files("C:/Users/ASAGUN/Desktop/Training/open-source-llm/kbs")
...
def install_vector_embeddings(library, embedding_model_name):
    ...
    sample_query = "what kind of cash card they will accept?"
    ...
    query_results = Query(library).semantic_query(sample_query,result_count=10)
    closest_result = min(query_results, key=lambda d: d['distance'])
