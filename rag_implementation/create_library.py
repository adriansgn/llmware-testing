...
def parsing_documents_into_library(library_name, sample_folder):
    ...
    ingestion_folder_path = "C:/Users/ASAGUN/Desktop/Training/open-source-llm/kbs"
    ...
    test_query = "WHAT IS THE MIN/MAX DAYS THAT MAY BE APPROVED ABSENCE BY SSS?"

    # print(f"\nStep 7 - running a test query - {test_query}\n")

    query_results = Query(library).text_query(test_query, result_count=1)
...
if __name__ == "__main__":
    ...
    selected_folder = 'kbs'    # e.g., "Agreements"
